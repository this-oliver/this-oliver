  ...
  <div>
      ...
      <b-col
        ...
        <b-button-group>
          <b-button
            ...
            :variant="(isDarkTheme) ? getDarkVariant(description.variant) : description.variant"
    ...
    <b-row
      ...
      <b-col
        sm="10"
        md="8">
        <p v-html="getSanitizedHtml(currentDescription.text)" />
      </b-col>
    </b-row>
  </div>
</template>
