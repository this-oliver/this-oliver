...
import type { ExperienceDocument } from "./models/experience";
...
async function updateExperience(id: string, patch: Partial<IExperience>): Promise<ExperienceDocument> {
  ...
  if (patch.org !== undefined)
    experience.org = patch.org;
  if (patch.startYear !== undefined)
    experience.startYear = patch.startYear;
  if (patch.endYear !== undefined)
    experience.endYear = patch.endYear;
  if (patch.description !== undefined)
    experience.description = patch.description;
  if (patch.type !== undefined)
    experience.type = patch.type;
  if (patch.link !== undefined)
    experience.link = patch.link;
  if (patch.image !== undefined)
    experience.image = patch.image;
